...
public:
  ...
  Config2_SShotFormat GetSShotImageFormat() { return (Config2_SShotFormat)sshot_format; }
  ...
  void SetSShotImageFormat(Config2_SShotFormat fmt) { sshot_format = (unsigned int)fmt; }
