...
ZEXTERN int
    ZEXPORT deflateTune OF((z_streamp strm, int good_length, int max_lazy, int nice_length, int max_chain));
/*
...
ZEXTERN int
    ZEXPORT inflateBack OF((z_streamp strm, in_func in, void FAR *in_desc, out_func out, void FAR *out_desc));
/*
...
ZEXTERN int
    ZEXPORT compress2 OF((Bytef * dest, uLongf *destLen, const Bytef *source, uLong sourceLen, int level));
/*
