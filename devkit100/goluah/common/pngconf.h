...
#if !defined(PNG_NO_SETJMP) && !defined(PNG_SETJMP_NOT_SUPPORTED) && !defined(PNG_NO_SETJMP_SUPPORTED)
...
#if !defined(PNG_FLOATING_POINT_SUPPORTED) || !defined(PNG_NO_FIXED_POINT_SUPPORTED)
...
#if !defined(PNG_NO_SEQUENTIAL_READ) && !defined(PNG_SEQUENTIAL_READ_SUPPORTED) &&                           \
...
#if !defined(PNG_NO_GET_INT_32) || defined(PNG_READ_oFFS_SUPPORTED) || defined(PNG_READ_pCAL_SUPPORTED)
...
#if !defined(PNG_NO_WRITE_INTERLACING_SUPPORTED) && !defined(PNG_WRITE_INTERLACING_SUPPORTED)
...
#if !defined(PNG_NO_WRITE_WEIGHTED_FILTER) && !defined(PNG_WRITE_WEIGHTED_FILTER) &&                         \
...
#if !defined(PNG_NO_SAVE_INT_32) || defined(PNG_WRITE_oFFS_SUPPORTED) || defined(PNG_WRITE_pCAL_SUPPORTED)
...
#if !defined(PNG_NO_POINTER_INDEXING) && !defined(PNG_POINTER_INDEXING_SUPPORTED)
...
#if defined(PNG_READ_SUPPORTED) && !defined(PNG_READ_ANCILLARY_CHUNKS_NOT_SUPPORTED) &&                      \
    !defined(PNG_NO_READ_ANCILLARY_CHUNKS)
#define PNG_READ_ANCILLARY_CHUNKS_SUPPORTED
#endif

/* PNG_WRITE_ANCILLARY_CHUNKS_NOT_SUPPORTED is deprecated. */
#if defined(PNG_WRITE_SUPPORTED) && !defined(PNG_WRITE_ANCILLARY_CHUNKS_NOT_SUPPORTED) &&                    \
...
#if defined(PNG_READ_iTXt_SUPPORTED) || defined(PNG_READ_tEXt_SUPPORTED) || defined(PNG_READ_zTXt_SUPPORTED)
#define PNG_READ_TEXT_SUPPORTED
#define PNG_TEXT_SUPPORTED
#endif
...
#define PNG_IMPEXP
    ...
    ((defined(_Windows) || defined(_WINDOWS) || defined(WIN32) || defined(_WIN32) || defined(__WIN32__)))
...
#define png_snprintf6(s1, n, fmt, x1, x2, x3, x4, x5, x6) sprintf(s1, fmt, x1, x2, x3, x4, x5, x6)
#endif
#endif
#endif
