...
void CCharacter::act_fig1()
{
	...
	else if(pdat->counter < 6){pdat->cnow = CELL_FIG2;}
	else if(pdat->counter < 9){pdat->cnow = CELL_FIG3;}
	else if(pdat->counter < 12){pdat->cnow = CELL_FIG4;}
	else if(pdat->counter < 15){pdat->cnow = CELL_FIG5;}
	else if(pdat->counter < 40){pdat->cnow = CELL_FIG6;}
	else{
...
void CCharacter::act_fig2(){act_fig1();}//���E���\����Ȃ�
void CCharacter::act_fig3(){act_fig1();}//���E���\����Ȃ�
...
void CCharacter::act_ikari()
{
	...
	if(pdat->counter < 20){pdat->cnow=CELL_NAGE1;pdat->y=0;}
	...
	else if(pdat->counter < 55){pdat->cnow=CELL_JAMP1;movex(2);pdat->y-=12;pdat->vy=-12;}//�W�����v���Ēǂ�����
	else if(pdat->counter < 90){//�͂�ŗ���
...
void CCharacter::act_escape()
{
	...
	if(pdat->counter > 30)pdat->aid = ACTID_NEUTRAL;
	...
	if(pdat->counter == 24){
		...
		for(i=0;i<6;i++)
		{
			if(clabul_folx[i])clabul_folx[i]->Go(pdat->muki,pdat->muki ? 1000 : -1000 ,0);
		}
	}
