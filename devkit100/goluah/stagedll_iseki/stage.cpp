...
const float g_jimenheightarr[15][16]=//地面の高さ
{
	...
	9,6,1,0,0,0,0,0,0,2,0,0,0,0,6,9,
...
void CStage::InitVrtx()//頂点座標初期化
{
	...
	vb_maewater[0].color=
		vb_maewater[1].color=
		vb_maewater[2].color=
		vb_maewater[3].color=0xAAFFFFFF;
	vb_maewater[0].y=
		vb_maewater[1].y=
		vb_maewater[2].y=
		vb_maewater[3].y=WATERHEIGHT;
	vb_maewater[0].x=-50;
	vb_maewater[0].z=-5;
	vb_maewater[1].x=50;
	vb_maewater[1].z=-5;
	...
	vb_jisaku1[2].color=
		vb_jisaku1[3].color=0xFF777777;
	vb_jisaku1[0].z=
		vb_jisaku1[1].z=
		vb_jisaku1[2].z=
		vb_jisaku1[3].z=40.0f;
	vb_jisaku1[0].x=-8;
	vb_jisaku1[0].y=-20;
	vb_jisaku1[1].x=8;
	vb_jisaku1[1].y=-20;
