...
int CStageList::GetStageCount() { return (infolist.size()); }
char *CStageList::GetStageDir(int index) { return (infolist[index].dir); }
char *CStageList::GetStageName(int index) { return (infolist[index].name); }
int CStageList::GetDameStageCount() { return (damelist.size()); }
char *CStageList::GetDameStageDir(int index) { return (damelist[index].dir); }
...
DWORD CStageList::GetDameStageReason(int index) { return (damelist[index].damereas); }
DWORD CStageList::GetStageVer(int index) { return (infolist[index].ver); }
DWORD CStageList::GetDameStageVer(int index) { return (damelist[index].ver); }

DWORD CStageList::GetStageCountRing(DWORD rindex) {
  if (rindex > ringlist.size() - 1)
    return 0;
...
DWORD CStageList::Ring2Serial(DWORD ring, DWORD index) {
  if (ring > ringlist.size() - 1)
    return 0;
  if (index > ringlist.at(ring).ring2serial.size() - 1)
    return 0;
