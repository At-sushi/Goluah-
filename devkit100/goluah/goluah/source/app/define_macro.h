...
#ifndef DELETECLASS
#define DELETECLASS(a)		if(a){delete(a);a=NULL;}				//!< クラス破棄
#endif

#ifndef RELEASEDLL
#define RELEASEDLL(a)		if(a){FreeLibrary(a);a=NULL;}			//!< DLL開放
#endif

#ifndef RELSURFACE
#define RELSURFACE(x)		if(x){g_draw.RelSurface(x);x=NULL;}		//!< CDirectDrawサーフェイス開放
#endif

#ifndef FREEMALM
#define FREEMALM(a)			if(a){free(a);a=NULL;}					//!< mallocで確保されたメモリ開放
#endif
