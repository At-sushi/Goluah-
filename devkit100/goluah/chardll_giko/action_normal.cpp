...
void CCharacter::act_tojyo() {
  ...
  if (ccounter < anmspd + offset)
    cell(CELL_TOJYO1);
  else if (ccounter < anmspd * 2 + offset)
    cell(CELL_TOJYO2);
  else if (ccounter < anmspd * 3 + offset)
    cell(CELL_TOJYO3);
  else if (ccounter < anmspd * 4 + offset)
    cell(CELL_TOJYO4);
  else if (ccounter < anmspd * 5 + offset)
    cell(CELL_TOJYO5);
  else if (ccounter < anmspd * 8 + offset)
    cell(CELL_TOJYO6);
  else {
...
void CCharacter::act_win() {
  ...
  if (ccounter < 50)
    cell(CELL_WIN1 + (ccounter / 2) % 2);
  else
    cell(CELL_WIN3 + (ccounter / 2) % 2);
