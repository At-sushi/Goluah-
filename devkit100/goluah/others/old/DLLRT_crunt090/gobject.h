...
typedef DWORD (*PFUNCS_STRIKEROK)(DWORD tid,
                                  DWORD oid,
                                  BOOL next); //ストライカー攻撃が可能かどうかを問い詰める
