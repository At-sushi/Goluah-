...
int GCDLoad(char *filename,GCD_CELL2 *pcdat,GCD_RECT *prdat,
			 GCD_HANTEI *phdat,GCD_CELLNAMES *pfhnames=NULL);


#ifdef ___GCDEDITER
//save
BOOL GCDSaveDlg(GCD_CELL2 *pcdat,GCD_RECT *prdat,
				GCD_HANTEI *phdat,GCD_CELLNAMES *pfhnames=NULL);
int GCDSave(char *filename,GCD_CELL2 *pcdat,GCD_RECT *prdat,
			 GCD_HANTEI *phdat,GCD_CELLNAMES *pfhnames=NULL);
BOOL GCDSaveHeader(GCD_CELLNAMES *pfhnames);

//other
void GCDSetInitialData(GCD_CELL2 *pcdat,GCD_RECT *prdat,
