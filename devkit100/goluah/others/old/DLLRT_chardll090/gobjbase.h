...
public:
  CCharacterInfo(LPCTSTR CharName,
                 DWORD CdiVersion,
...
public:
  ...
  CBulletBase(CCharacterBase *parent,
              CDI_CHARACTERINFO2 *info,
              BYTE userID = 0xFF,
              BYTE userNo = 0xFF); //コンストラクタ(3) ネットワーク用
...
public:
  CClassicalBullet(CCharacterBase *parent,
                   CDI_CHARACTERINFO2 *info,
                   BULLETINFO_A *bulinfo,
                   BYTE userID = 0xFF,
                   BYTE userNo = 0xFF);
