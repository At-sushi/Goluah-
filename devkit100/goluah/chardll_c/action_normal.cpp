...
void CCharacter::act_tojyo() //登場
{
  ...
  if (pdat->counter < 30)
    pdat->cnow = CELL_TOJO1;
  else if (pdat->counter < 32)
    pdat->cnow = CELL_TOJO2;
  else if (pdat->counter < 37)
    pdat->cnow = CELL_TOJO3;
  else if (pdat->counter < 60)
    pdat->cnow = CELL_TOJO4;
  else if (pdat->counter < 65)
    pdat->cnow = CELL_TOJO5;
  else {
...
void CCharacter::act_win() //勝利
{
  ...
  if (pdat->counter < 10)
    ...
    pdat->cnow = CELL_WIN3;
  else if (pdat->counter < 100)
    pdat->cnow = CELL_WIN4;
  else if (pdat->counter < 105)
    pdat->cnow = CELL_WIN5;
  else if (pdat->counter < 106)
    pdat->cnow = CELL_WIN6;
  else
    pdat->cnow = CELL_WIN7;
