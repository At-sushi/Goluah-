    ...
    for (UINT i = 0; i < MISSILE_NUM; i++) {
      if (pbul_miss[i]) {
        if (pbul_miss[i]->isReady()) {
          pbul_miss[i]->Go(pdat->muki, pdat->x + zurex(100), -70, 15 * (pdat->muki ? -1 : 1), 0);
          break;
        }
      }
    }
...
void CCharacter::act_poi_firethrow() {
  if (ccounter == 0)
    PlayMySound(wave_poi_2d);
  const UINT duration = DUR_FIRETHROW;

  if (ccounter < 2)
    cell(CELL_FIRETHROW1);
  else if (ccounter < 4)
    cell(CELL_FIRETHROW2);
  else if (ccounter < 6)
    cell(CELL_FIRETHROW3);
  else if (ccounter < 8)
    cell(CELL_FIRETHROW4);
  else if (ccounter < 10)
    cell(CELL_FIRETHROW5);
  else if (ccounter < 10 + duration)
    cell(CELL_FIRETHROW6);
  else if (ccounter < 10 + duration + 2)
    cell(CELL_FIRETHROW5);
  else if (ccounter < 10 + duration + 4)
    cell(CELL_FIRETHROW4);
  else if (ccounter < 10 + duration + 8)
    cell(CELL_FIRETHROW3);
  else if (ccounter < 10 + duration + 10)
    cell(CELL_FIRETHROW2);
  else if (ccounter < 10 + duration + 12)
    cell(CELL_FIRETHROW1);
  else
    ChangeAction(ACTID_NEUTRAL);
...
void CCharacter::act_poi_shot() {
  ...
  if (ccounter < 2)
    ...
    cell(CELL_SHOT11);
  else if (ccounter < 28 + suki)
    cell(CELL_SHOT12);
  else if (ccounter < 30 + suki + 2)
    cell(CELL_SHOT7);
  else if (ccounter < 30 + suki + 4)
    cell(CELL_SHOT6);
  else if (ccounter < 30 + suki + 6)
    cell(CELL_SHOT5);
  else if (ccounter < 30 + suki + 8)
    cell(CELL_SHOT4);
  else if (ccounter < 30 + suki + 10)
    cell(CELL_SHOT3);
  else if (ccounter < 30 + suki + 12)
    cell(CELL_SHOT2);
  else if (ccounter < 30 + suki + 14)
    cell(CELL_SHOT1);
  else
    ChangeAction(ACTID_NEUTRAL);
...
void CCharacter::act_poi_rifle() {
  ...
  if (ccounter < 2)
    ...
    cell(CELL_RIFLE4);
  else if (ccounter < 10 + kamae)
    cell(CELL_RIFLE5); //構え , shot!!
  else if (ccounter < 12 + kamae + 2)
    cell(CELL_RIFLE6);
  else if (ccounter < 12 + kamae + 4)
    cell(CELL_RIFLE7);
  else if (ccounter < 12 + kamae + 6)
    cell(CELL_RIFLE8);
  else if (ccounter < 12 + kamae + 8 + suki)
    cell(CELL_RIFLE5);
  else if (ccounter < 12 + kamae + 6 + suki + 2)
    cell(CELL_RIFLE4);
  else if (ccounter < 12 + kamae + 6 + suki + 4)
    cell(CELL_RIFLE3);
  else if (ccounter < 12 + kamae + 6 + suki + 6)
    cell(CELL_RIFLE2);
  else if (ccounter < 12 + kamae + 6 + suki + 8)
    cell(CELL_RIFLE1);
  else
    ChangeAction(ACTID_NEUTRAL);
...
void CCharacter::act_poi_rocket() {
  ...
  if (ccounter < 2)
    ...
    cell(CELL_BAZOOKA6);
  else if (ccounter < 14 + tame)
    cell(CELL_BAZOOKA7);
  else if (ccounter < 14 + tame + dur + 2)
    cell(CELL_BAZOOKA8);
  else if (ccounter < 14 + tame + dur + 4)
    cell(CELL_BAZOOKA9);
  else if (ccounter < 14 + tame + dur + 6)
    cell(CELL_BAZOOKA10);
  else if (ccounter < 14 + tame + dur + 8)
    cell(CELL_BAZOOKA11);
  else if (ccounter < 14 + tame + dur + 10)
    cell(CELL_BAZOOKA12);
  else if (ccounter < 14 + tame + dur + 12)
    cell(CELL_BAZOOKA13);
  else if (ccounter < 14 + tame + dur + 14)
    cell(CELL_BAZOOKA14);
  else
    ChangeAction(ACTID_NEUTRAL);
...
void CCharacter::act_poi_missile_v2(UINT counter) {
  ...
  if (counter == 2) {
    for (UINT i = 0; i < MISSILE_NUM; i++) {
      if (pbul_miss[i]) {
        if (pbul_miss[i]->isReady()) {
          pbul_miss[i]->Go(pdat->muki, pdat->x + zurex(-20), -85, 0, -15);
          break;
        }
      }
    }
...
void CCharacter::act_poi_httplaser() {
  if (ccounter == 0)
    PlayMySound(wave_poi_3e);
  UINT spd = 2;
  UINT dur = 60;

  if (ccounter < spd * 1)
    cell(CELL_LASER1);
  else if (ccounter < spd * 2)
    cell(CELL_LASER2);
  else if (ccounter < spd * 3)
    cell(CELL_LASER3);
  else if (ccounter < spd * 4)
    cell(CELL_LASER4);
  else if (ccounter < spd * 5)
    cell(CELL_LASER5);
  else if (ccounter < spd * 6)
    cell(CELL_LASER6);
  else if (ccounter < spd * 7 + 10)
    cell(CELL_LASER7);
  else if (ccounter < spd * 8 + dur)
    cell(CELL_LASER8);
  else if (ccounter < spd * 8 + dur + spd * 1)
    cell(CELL_LASER7);
  else if (ccounter < spd * 8 + dur + spd * 2)
    cell(CELL_LASER6);
  else if (ccounter < spd * 8 + dur + spd * 3)
    cell(CELL_LASER5);
  else if (ccounter < spd * 8 + dur + spd * 4)
    cell(CELL_LASER4);
  else if (ccounter < spd * 8 + dur + spd * 5)
    cell(CELL_LASER3);
  else if (ccounter < spd * 8 + dur + spd * 6)
    cell(CELL_LASER2);
  else if (ccounter < spd * 8 + dur + spd * 7)
    cell(CELL_LASER1);
  else
    ChangeAction(ACTID_NEUTRAL);
...
void CCharacter::act_poi_eraser99() {
  ...
  if (ccounter == 0)
    PlayMySound(wave_poi_3f1);
  if (ccounter == 35 * spd)
    PlayMySound(wave_poi_3f2);
  if (ccounter == 35 * spd + 150)
    PlayMySound(wave_poi_3f3);
...
void CCharacter::act_moyamoya2() {
  if (pdat->counter == 0)
    pbul_moya = pbul_moyaB;
  act_moyamoya();
}
void CCharacter::act_moyamoya3() {
  if (pdat->counter == 0)
    pbul_moya = pbul_moyaC;
  act_moyamoya();
}
