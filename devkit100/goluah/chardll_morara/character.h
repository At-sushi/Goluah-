...
public:
  ...
  void
  Startup(ATTACKINFO *patkinfo, DWORD hit_msg_id, DWORD grd_msg_id, BOOL muki, double x, double y, double vx);
  BOOL m_extended;
...
public:
  ...
  void Setup(ATTACKINFO *patkinfo, DWORD hit_msg_id, DWORD grd_msg_id);
