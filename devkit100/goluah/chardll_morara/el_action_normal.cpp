...
void CCharacterEL::act_tojyo() //登場
{
  ...
  if (ccounter < 12)
    ...
    if (cntr < 3)
      ...
      cell(CELL_TOJYO5);
    else if (cntr < 9 + anmspd * 1)
      cell(CELL_TOJYO6);
    else if (cntr < 9 + anmspd * 2)
      cell(CELL_TOJYO7);
    else if (cntr < 9 + anmspd * 3)
      cell(CELL_TOJYO8);
    else if (cntr < 9 + anmspd * 4)
      cell(CELL_TOJYO9);
    else if (cntr < 9 + anmspd * 5)
      cell(CELL_TOJYO10);
    else if (cntr < 9 + anmspd * 6)
      cell(CELL_TOJYO11);
    else if (cntr < 9 + anmspd * 7)
      cell(CELL_TOJYO12);
    else if (cntr < 9 + anmspd * 8)
      cell(CELL_TOJYO13);
    else if (cntr < 9 + anmspd * 9)
      cell(CELL_TOJYO14);
    else
      cell(CELL_JAMPF);
...
void CCharacterEL::act_timeoverlose() { cell(CELL_TLOSE1 + (ccounter / 2) % 2); }
