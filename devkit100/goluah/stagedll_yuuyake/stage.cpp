...
void CStage::InitVrtx() //頂点座標初期化
{
  ...
  vb_jimen[0].y = vb_jimen[1].y = vb_jimen[2].y = vb_jimen[3].y = 0;
  vb_jimen[0].z = vb_jimen[2].z = 0.3f;
  vb_jimen[1].z = vb_jimen[3].z = -1.0f;

  //フェンス
  vb_fens[0].color = vb_fens[1].color = vb_fens[2].color = vb_fens[3].color = 0xFFFFFFFF;
  vb_fens[0].tu = -20;
  vb_fens[0].tv = -3;
  ...
  vb_fens[0].z = vb_fens[1].z = vb_fens[2].z = vb_fens[3].z = 0.3f;
  vb_fens[0].y = vb_fens[2].y = -0.6f;
  vb_fens[1].y = vb_fens[3].y = 0.0f;

  //フェンス手すり
  vb_fens2[0][0].color = vb_fens2[0][1].color = vb_fens2[0][2].color = vb_fens2[0][3].color = 0xFF442277;
  vb_fens2[0][0].tu = -20;
  vb_fens2[0][0].tv = -3;
  ...
  vb_fens2[0][0].z = vb_fens2[0][1].z = vb_fens2[0][2].z = vb_fens2[0][3].z = 0.3f;
  vb_fens2[0][0].y = vb_fens2[0][2].y = -0.63f;
  vb_fens2[0][1].y = vb_fens2[0][3].y = -0.6f;
  //フェンス手すり(下)
  vb_fens2[1][0].color = vb_fens2[1][1].color = vb_fens2[1][2].color = vb_fens2[1][3].color = 0xFF442277;
  vb_fens2[1][0].tu = -20;
  vb_fens2[1][0].tv = -3;
  ...
  vb_fens2[1][0].z = vb_fens2[1][1].z = vb_fens2[1][2].z = vb_fens2[1][3].z = 0.3f;
  ...
  vb_buil1a[0][3].tu = 1;
  vb_buil1a[0][3].tv = 1;
  vb_buil1a[0][0].x = vb_buil1a[0][1].x = vb_buil1a[0][2].x = vb_buil1a[0][3].x = -0.5f;
  ...
  vb_buil1a[1][3].tv = 1;
  vb_buil1a[1][0].z = vb_buil1a[1][1].z = vb_buil1a[1][2].z = vb_buil1a[1][3].z = 0.5f;
  ...
  vb_buil1b[3].tu = 15;
  vb_buil1b[3].tv = 10;
  vb_buil1b[0].y = vb_buil1b[1].y = vb_buil1b[2].y = vb_buil1b[3].y = vb_buil1a[1][0].y;
  ...
  vb_buil1c[3].tu = 8;
  vb_buil1c[3].tv = 8;
  vb_buil1c[0].z = vb_buil1c[1].z = vb_buil1c[2].z = vb_buil1c[3].z = 1.5f;
  ...
  for (i = 0; i < 10; i++) {
    if (SUCCEEDED(d3ddev->CreateVertexBuffer(sizeof(MYVERTEX3D) * 4, 0, FVF_3DVERTEX, D3DPOOL_MANAGED,
                                             &vb_buil1d[i])) &&
  ...
  vb_buil2b[3].tu = 1;
  vb_buil2b[3].tv = 2;
  vb_buil2b[0].z = vb_buil2b[1].z = vb_buil2b[2].z = vb_buil2b[3].z = 0.7f;
  ...
  vb_buil2a[3].tu = 1;
  vb_buil2a[3].tv = 2;
  vb_buil2a[0].x = vb_buil2a[1].x = vb_buil2a[2].x = vb_buil2a[3].x = -0.5f;
  ...
  vb_sky[0].z = vb_sky[1].z = vb_sky[2].z = vb_sky[3].z = 20.0f;
  vb_sky[0].y = vb_sky[2].y = -9.0f;
  vb_sky[1].y = vb_sky[3].y = 9.0f;

  //背景１
  vb_bg1[0].color = vb_bg1[1].color = vb_bg1[2].color = vb_bg1[3].color = 0xFFFFFFFF;
  vb_bg1[0].tu = 0;
  vb_bg1[0].tv = 0;
  ...
  vb_bg1[0].z = vb_bg1[1].z = vb_bg1[2].z = vb_bg1[3].z = 12.0f;
  vb_bg1[0].y = vb_bg1[2].y = -2.5f;
  vb_bg1[1].y = vb_bg1[3].y = 3.5f;

  //背景２
  vb_bg2[0].color = vb_bg2[1].color = vb_bg2[2].color = vb_bg2[3].color = 0xFFFFFFFF;
  vb_bg2[0].tu = 0;
  vb_bg2[0].tv = 0;
  ...
  vb_bg2[0].z = vb_bg2[1].z = vb_bg2[2].z = vb_bg2[3].z = 8.0f;
...
void CStage::LoadTextures() //テクスチャ読込み
{
  ...
  D3DXCreateTextureFromFileA(d3ddev, filename, &ptex_jimen);
  ...
  D3DXCreateTextureFromFileExA(d3ddev, filename, 0, 0, 0, 0, D3DFMT_A1R5G5B5, D3DPOOL_MANAGED,
                               D3DX_FILTER_POINT, D3DX_FILTER_POINT, 0xFF000000, NULL, NULL, &ptex_fens);
  ...
  D3DXCreateTextureFromFileExA(d3ddev, filename, 0, 0, 0, 0, D3DFMT_X1R5G5B5, D3DPOOL_MANAGED,
                               D3DX_FILTER_POINT, D3DX_FILTER_POINT, 0, NULL, NULL, &ptex_buil1a);
  //ビル１看板裏
  sprintf(filename, "%s\\tex_brdura.bmp", GetDLLPath());
  D3DXCreateTextureFromFileA(d3ddev, filename, &ptex_brdura);

  //ビル2裏
  sprintf(filename, "%s\\tex_buil2a.bmp", GetDLLPath());
  D3DXCreateTextureFromFileExA(d3ddev, filename, 0, 0, 0, 0, D3DFMT_X1R5G5B5, D3DPOOL_MANAGED,
                               D3DX_FILTER_POINT, D3DX_FILTER_POINT, 0, NULL, NULL, &ptex_buil2a);
  ...
  D3DXCreateTextureFromFileExA(d3ddev, filename, 0, 0, 0, 0, D3DFMT_A1R5G5B5, D3DPOOL_MANAGED,
                               D3DX_FILTER_POINT, D3DX_FILTER_POINT, 0xFF000000, NULL, NULL, &ptex_bg1);
  //背景２
  sprintf(filename, "%s\\tex_bg2.png", GetDLLPath());
  D3DXCreateTextureFromFileExA(d3ddev, filename, 0, 0, 0, 0, D3DFMT_A1R5G5B5, D3DPOOL_MANAGED,
                               D3DX_FILTER_POINT, D3DX_FILTER_POINT, 0xFF000000, NULL, NULL, &ptex_bg2);
...
void CStage::DrawJimen() {
  ...
  d3ddev->DrawPrimitiveUP(D3DPT_TRIANGLESTRIP, 2, vb_jimen, sizeof(MYVERTEX3D));

  //フェンス
  d3ddev->SetTexture(0, ptex_fens);
  d3ddev->DrawPrimitiveUP(D3DPT_TRIANGLESTRIP, 2, vb_fens, sizeof(MYVERTEX3D));
  d3ddev->SetTexture(0, NULL);
  d3ddev->DrawPrimitiveUP(D3DPT_TRIANGLESTRIP, 2, vb_fens2[0], sizeof(MYVERTEX3D));
  d3ddev->DrawPrimitiveUP(D3DPT_TRIANGLESTRIP, 2, vb_fens2[1], sizeof(MYVERTEX3D));
}
...
void CStage::DrawBackGround() {
  ...
  d3ddev->DrawPrimitiveUP(D3DPT_TRIANGLESTRIP, 2, vb_bg2, sizeof(MYVERTEX3D));

  //背景１
  d3ddev->SetTexture(0, ptex_bg1);
  d3ddev->DrawPrimitiveUP(D3DPT_TRIANGLESTRIP, 2, vb_bg1, sizeof(MYVERTEX3D));
