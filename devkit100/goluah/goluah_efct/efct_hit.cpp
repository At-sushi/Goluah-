...
BOOL CFxHitmark1::Draw() { return pdat->counter < 12 ? FALSE : TRUE; }
...
BOOL CFxHitmark4::Draw() {
  ...
  if (counter < 15) { //円
    g_draw.DrawCircle((int)pdat->x, (int)pdat->y, (counter + 4) * 5, 10, 0,
                      0x00FFAA00 + (((255 - counter * (255 / 15)) * 255 * 255 * 255) & 0xFF000000), TRUE);
  }
  if (counter >= 20)
    return (TRUE);
